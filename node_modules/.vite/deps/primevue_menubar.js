...
import {
  script as script2
} from "./chunk-5A3YDQYS.js";
import {
  Ripple
} from "./chunk-WTSX4SNP.js";
import "./chunk-54G2UROS.js";
import "./chunk-4MM6BGYL.js";
import {
  script
...
var script5 = {
  ...
  methods: {
    ...
    onItemClick: function onItemClick2(event) {
      ...
      var root2 = l(processedItem.parent);
    ...
    onArrowDownKey: function onArrowDownKey(event) {
      ...
      var root2 = processedItem ? l(processedItem.parent) : null;
      if (root2) {
        var grouped = this.isProccessedItemGroup(processedItem);
        if (grouped) {
          this.onItemChange({

...
var ue = (e = {}, t2, r, s4) => {
  if (t2) {
    let { variable: i2, options: a2 } = S.defaults || {}, { prefix: n, transform: l2 } = (e == null ? void 0 : e.options) || a2 || {}, o = G(t2, k) ? t2 : `{${t2}}`;
    return s4 === "value" || l(s4) && l2 === "strict" ? S.getTokenValue(t2) : Y2(o, void 0, n, [i2.excludedKeyRegex], r);
  }
  return "";
};
function ar(e, ...t2) {
...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let g3 = m2[u], f2 = ve(g3), p = G(u, a2) ? Q2(d2) : Q2(d2, re(u));
      if (i(f2)) o.push({ node: f2, path: p });
      else {
        let y2 = ae2(p), R2 = Y2(f2, p, s4, [a2]);
        Re(l2, y2, R2);
        let T2 = p;
...
var b = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  var R2, T2, j, O, M, z3, V;
  let { preset: a2, options: n } = t2, l2, o, c3, m2, d2, u, g3;
  if (s(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te, extend: re2 } = a2, f2 = te || {}, { colorScheme: K3 } = f2, A2 = v2(f2, ["colorScheme"]), x2 = re2 || {}, { colorScheme: X } = x2, G2 = v2(x2, ["colorScheme"]), p = K3 || {}, { dark: U2 } = p, B = v2(p, ["dark"]), y2 = X || {}, { dark: I } = y2, H2 = v2(y2, ["dark"]), W2 = s(L) ? this._toVariables({ primitive: L }, n) : {}, q2 = s(A2) ? this._toVariables({ semantic: A2 }, n) : {}, Z = s(B) ? this._toVariables({ light: B }, n) : {}, pe = s(U2) ? this._toVariables({ dark: U2 }, n) : {}, fe = s(G2) ? this._toVariables({ semantic: G2 }, n) : {}, ye = s(H2) ? this._toVariables({ light: H2 }, n) : {}, Se = s(I) ? this._toVariables({ dark: I }, n) : {}, [Me, ze] = [(R2 = W2.declarations) != null ? R2 : "", W2.tokens], [Ke, Xe] = [(T2 = q2.declarations) != null ? T2 : "", q2.tokens || []], [Ge, Ue] = [(j = Z.declarations) != null ? j : "", Z.tokens || []], [Be, Ie] = [(O = pe.declarations) != null ? O : "", pe.tokens || []], [He, We] = [(M = fe.declarations) != null ? M : "", fe.tokens || []], [qe, Ze] = [(z3 = ye.declarations) != null ? z3 : "", ye.tokens || []], [Fe, Je] = [(V = Se.declarations) != null ? V : "", Se.tokens || []];
    ...
    d2 = `${et}${tt2}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], g3 = m(a2.css, { dt: E2 });
  }
  ...
  if (s(t2) && r.transform !== "strict") {
    let y2 = e.replace("-directive", ""), m2 = t2, { colorScheme: R2, extend: T2, css: j } = m2, O = v2(m2, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M } = d2, z3 = v2(d2, ["colorScheme"]), u = R2 || {}, { dark: V } = u, L = v2(u, ["dark"]), g3 = M || {}, { dark: te } = g3, re2 = v2(g3, ["dark"]), K3 = s(O) ? this._toVariables({ [y2]: h(h({}, O), z3) }, r) : {}, A2 = s(L) ? this._toVariables({ [y2]: h(h({}, L), re2) }, r) : {}, X = s(V) ? this._toVariables({ [y2]: h(h({}, V), te) }, r) : {}, [G2, U2] = [(f2 = K3.declarations) != null ? f2 : "", K3.tokens || []], [B, I] = [(x2 = A2.declarations) != null ? x2 : "", A2.tokens || []], [H2, W2] = [(p = X.declarations) != null ? p : "", X.tokens || []], q2 = this.transformCSS(y2, `${G2}${B}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y2, H2, "dark", "variable", r, i2, a2, n);
  ...
  let a2 = function(l2, o = {}, c3 = []) {
    ...
    Object.entries(l2).forEach(([m2, d2]) => {
      ...
      i(d2) ? n(d2, u, g3) : (i2[u] || (i2[u] = { paths: [], computed: (f2, x2 = {}, p = []) => {
  ...
  getStyleSheet: function getStyleSheet() {
    ...
    if (this.css) {
      ...
      var _props = Object.entries(props).reduce(function(acc, _ref2) {
        var _ref3 = _slicedToArray(_ref2, 2), k2 = _ref3[0], v3 = _ref3[1];
        return acc.push("".concat(k2, '="').concat(v3, '"')) && acc;
      }, []).join(" ");
  ...
  getThemeStyleSheet: function getThemeStyleSheet(params) {
    ...
    if (this.style) {
      ...
      var _props = Object.entries(props).reduce(function(acc, _ref4) {
        var _ref5 = _slicedToArray(_ref4, 2), k2 = _ref5[0], v3 = _ref5[1];
        return acc.push("".concat(k2, '="').concat(v3, '"')) && acc;
      }, []).join(" ");
...
//# sourceMappingURL=chunk-MQ7FTCNE.js.map

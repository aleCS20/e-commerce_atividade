...
var BaseDirective = {
  ...
  _getPTDatasets: function _getPTDatasets() {
    ...
    return _objectSpread(_objectSpread({}, key === "root" && _defineProperty({}, "".concat(datasetPrefix, "name"), g(instance.$name))), {}, _defineProperty({}, "".concat(datasetPrefix, "section"), g(key)));
  },
...
var Ripple = BaseRipple.extend("ripple", {
  ...
  methods: {
    ...
    createRipple: function createRipple(el) {
      ...
      if (!ink) {
        ink = U("span", _defineProperty2(_defineProperty2({
          role: "presentation",
          "aria-hidden": true,
          "data-p-ink": true,
...
//# sourceMappingURL=chunk-WTSX4SNP.js.map

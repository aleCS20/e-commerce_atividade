import {
  script as script2
} from "./chunk-S2IIGP6C.js";
import {
  Base,
  script
} from "./chunk-YRQPO54T.js";
import {
  PrimeVueService
} from "./chunk-QB5FQRF5.js";
import {
  BaseStyle,
  C,
  C2,
...
var BaseDirective = {
  ...
  _getPTDatasets: function _getPTDatasets() {
    ...
    return _objectSpread(_objectSpread({}, key === "root" && _defineProperty2({}, "".concat(datasetPrefix, "name"), g(instance.$name))), {}, _defineProperty2({}, "".concat(datasetPrefix, "section"), g(key)));
  },
...
var Ripple = BaseRipple.extend("ripple", {
  ...
  methods: {
    ...
    createRipple: function createRipple(el) {
      ...
      if (!ink) {
        ink = U("span", _defineProperty3(_defineProperty3({
          role: "presentation",
          "aria-hidden": true,
          "data-p-ink": true,
...
var script5 = {
  ...
  computed: {
    ...
    dataP: function dataP2() {
      return f(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5(_defineProperty5({}, this.size, this.size), "icon-only", this.hasIcon && !this.label && !this.badge), "loading", this.loading), "fluid", this.hasFluid), "rounded", this.rounded), "raised", this.raised), "outlined", this.outlined || this.variant === "outlined"), "text", this.text || this.variant === "text"), "link", this.link || this.variant === "link"), "vertical", (this.iconPos === "top" || this.iconPos === "bottom") && this.label));
    },
    dataIconP: function dataIconP() {
      return f(_defineProperty5(_defineProperty5({}, this.iconPos, this.iconPos), this.size, this.size));
    },
    dataLabelP: function dataLabelP() {
      return f(_defineProperty5(_defineProperty5({}, this.size, this.size), "icon-only", this.hasIcon && !this.label && !this.badge));
    }
  },
  components: {
    SpinnerIcon: script3,
